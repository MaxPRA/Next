...
#main variables
TOKEN = '1456894637:AAEZ6nxzvJnerSX-jW5Euar-hYOaV0TVx00'
...
def askAmount(message):
    ...
    if task.mySource == 'top':
        output = parserr.getTitlesFromTop(int(text), task.myFilter)
    else:
        output = parserr.getTitlesFromAll(int(text), task.myFilter)
